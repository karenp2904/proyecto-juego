...
import { ItemData } from "../CrearItemPage";
import { TiposService } from "../../../../../services/Tipos";

interface ItemFormProps {
    ItemData: ItemData;
  onSubmit: () => void;
  setHeroData: React.Dispatch<React.SetStateAction<ItemData>>;
}
...
const ItemForm: React.FC<ItemFormProps> = ({
  ...
  useEffect(() => {
    TiposService.obtenerSubTipos(ItemData.tipo)
        .then(res => {
  ...
  const handleEstadisticasChange = (
    name: keyof ItemData["estadisticas"],
      ...
      <div>
        ...
        <div className="grid grid-cols-[repeat(auto-fill,minmax(270px,1fr))] gap-4">
          <Input
            ...
            type="number"
            label={"Poder:"}
            value={ItemData.estadisticas.poder.toString()}
            name="poder"
          ...
          <Input
            id={""}
            label={"Vida:"}
            value={ItemData.estadisticas.vida.toString()}
            name="vida"
          ...
          <Input
            id={""}
            label={"Defensa:"}
            value={ItemData.estadisticas.defensa.toString()}
            name="defensa"
        ...
        <div className="grid grid-cols-[repeat(auto-fill,minmax(270px,1fr))] gap-4">
          <Input
            id={""}
            label={"Efectos:"}
            value={ItemData.armas.efectos.toString()}
            name="efectos"
            onChange={(e) =>
          ...
          />
            ...
            value={ItemData.armas.porcentajeCaida.toString()}
