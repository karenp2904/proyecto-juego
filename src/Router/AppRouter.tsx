    ...
    <BrowserRouter basename={basename}>
      <Routes>
        ...
        <Route element={<MainNavBar />}>
          ...
          <Route
            path={Router.unirseapartida}
            element={<UnirseapartidaPage />}
          />
        </Route>
        ...
        <Route element={<AdminApp />}>
          ...
          <Route
            path="/admin/inventario/crearheroe"
            element={<CrearHeroePage />}
          />{" "}
          //cambie la URL para que tenga sentido
          <Route
            path="/admin/inventario/creararma"
            element={<CrearArmaPage />}
          />
          <Route
            path="/admin/inventario/creararmadura"
            element={<CrearArmaduraPage />}
          />
          <Route
            path="/admin/inventario/crearitem"
            element={<CrearItemPage />}
          />
          <Route
            path="/admin/inventario/crearepica"
            element={<CrearEpicaPage />}
          />
        </Route>
      </Routes>
    </BrowserRouter>
